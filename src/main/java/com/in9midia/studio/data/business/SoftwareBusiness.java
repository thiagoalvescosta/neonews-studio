...
public class SoftwareBusiness {
     ...
     * @generated
     */
    public Software post(final Software entity) throws Exception {
      // begin-user-code  
      // end-user-code  
     ...
     * @generated
     */
    public Software get(java.lang.String id) throws Exception {
      // begin-user-code  
      // end-user-code        
       Software result = repository.findOne(id);
      // begin-user-code  
      // end-user-code        
      return result;
    }
     ...
     * @generated
     */
    public Software put(final Software entity) throws Exception {
      // begin-user-code  
      // end-user-code        
     ...
     * @generated
     */
    public Software put(final java.lang.String id,final Software entity) throws Exception {
      // begin-user-code  
      // end-user-code        
      repository.saveAndFlush(entity);
      // begin-user-code  
  ...
  public List<Software> list ( Pageable pageable ){
    // begin-user-code  
    // end-user-code        
    List<Software> result = repository.list (  pageable );
    // begin-user-code  
    // end-user-code        
    return result;
  }
