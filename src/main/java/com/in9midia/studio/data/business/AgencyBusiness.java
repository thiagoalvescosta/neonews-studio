...
public class AgencyBusiness {
     ...
     * @generated
     */
    public Agency post(final Agency entity) throws Exception {
      // begin-user-code  
      // end-user-code  
     ...
     * @generated
     */
    public Agency get(java.lang.String id) throws Exception {
      // begin-user-code  
      // end-user-code        
       Agency result = repository.findOne(id);
      // begin-user-code  
      // end-user-code        
      return result;
    }
     ...
     * @generated
     */
    public Agency put(final Agency entity) throws Exception {
      // begin-user-code  
      // end-user-code        
     ...
     * @generated
     */
    public Agency put(final java.lang.String id,final Agency entity) throws Exception {
      // begin-user-code  
      // end-user-code        
      repository.saveAndFlush(entity);
      // begin-user-code  
  ...
  public List<Agency> list ( Pageable pageable ){
    // begin-user-code  
    // end-user-code        
    List<Agency> result = repository.list (  pageable );
    // begin-user-code  
    // end-user-code        
    return result;
  }
