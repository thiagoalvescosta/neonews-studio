...
public class TemplateBusiness {
     ...
     * @generated
     */
    public Template post(final Template entity) throws Exception {
      // begin-user-code  
      // end-user-code  
     ...
     * @generated
     */
    public Template get(java.lang.String id) throws Exception {
      // begin-user-code  
      // end-user-code        
     ...
     * @generated
     */
    public Template put(final Template entity) throws Exception {
      // begin-user-code  
      // end-user-code        
     ...
     * @generated
     */
    public Template put(final java.lang.String id,final Template entity) throws Exception {
      // begin-user-code  
      // end-user-code        
      repository.saveAndFlush(entity);
      // begin-user-code  
  ...
  public List<Template> list ( Pageable pageable ){
    // begin-user-code  
    // end-user-code        
    List<Template> result = repository.list (  pageable );
    // begin-user-code  
    // end-user-code        
    return result;
  }
