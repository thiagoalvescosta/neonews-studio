...
public interface SoftwareDAO extends JpaRepository<Software, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity.address FROM Terminal entity WHERE entity.software.id = :id")
  public List<Address> listAddress(@Param(value="id") java.lang.String id,  Pageable pageable);
     ...
     */
    @Modifying
    @Query("DELETE FROM Terminal entity WHERE entity.software.id = :instanceId AND entity.address.id = :relationId")
   ...
   * @generated
   */
  @Query("SELECT entity.campaign FROM Terminal entity WHERE entity.software.id = :id")
  public List<Campaign> listCampaign(@Param(value="id") java.lang.String id,  Pageable pageable);
     ...
     */
    @Modifying
    @Query("DELETE FROM Terminal entity WHERE entity.software.id = :instanceId AND entity.campaign.id = :relationId")
   ...
   * @generated
   */
  @Query("SELECT entity.campaignBlock FROM Terminal entity WHERE entity.software.id = :id")
  public List<CampaignBlock> listCampaignBlock(@Param(value="id") java.lang.String id,  Pageable pageable);
     ...
     */
    @Modifying
    @Query("DELETE FROM Terminal entity WHERE entity.software.id = :instanceId AND entity.campaignBlock.id = :relationId")
   ...
   * @generated
   */
  @Query("SELECT entity.category FROM Terminal entity WHERE entity.software.id = :id")
  public List<Category> listCategory(@Param(value="id") java.lang.String id,  Pageable pageable);
     ...
     */
    @Modifying
    @Query("DELETE FROM Terminal entity WHERE entity.software.id = :instanceId AND entity.category.id = :relationId")
   ...
   * @generated
   */
  @Query("SELECT entity.company FROM Terminal entity WHERE entity.software.id = :id")
  public List<Company> listCompany(@Param(value="id") java.lang.String id,  Pageable pageable);
     ...
     */
    @Modifying
    @Query("DELETE FROM Terminal entity WHERE entity.software.id = :instanceId AND entity.company.id = :relationId")
   ...
   * @generated
   */
  @Query("SELECT entity.person FROM Terminal entity WHERE entity.software.id = :id")
  public List<Person> listPerson(@Param(value="id") java.lang.String id,  Pageable pageable);
     ...
     */
    @Modifying
    @Query("DELETE FROM Terminal entity WHERE entity.software.id = :instanceId AND entity.person.id = :relationId")
   ...
   * @generated
   */
  @Query("SELECT entity.profile FROM Terminal entity WHERE entity.software.id = :id")
  public List<Profile> listProfile(@Param(value="id") java.lang.String id,  Pageable pageable);
     ...
     */
    @Modifying
    @Query("DELETE FROM Terminal entity WHERE entity.software.id = :instanceId AND entity.profile.id = :relationId")
   ...
   * @generated
   */
  @Query("SELECT entity.sga FROM Terminal entity WHERE entity.software.id = :id")
  public List<Sga> listSga(@Param(value="id") java.lang.String id,  Pageable pageable);
     ...
     */
    @Modifying
    @Query("DELETE FROM Terminal entity WHERE entity.software.id = :instanceId AND entity.sga.id = :relationId")
   ...
   * @generated
   */
  @Query("SELECT entity.terminalType FROM Terminal entity WHERE entity.software.id = :id")
  public List<TerminalType> listTerminalType(@Param(value="id") java.lang.String id,  Pageable pageable);
     ...
     */
    @Modifying
    @Query("DELETE FROM Terminal entity WHERE entity.software.id = :instanceId AND entity.terminalType.id = :relationId")
   ...
   * @generated
   */
  @Query("SELECT entity.tvType FROM Terminal entity WHERE entity.software.id = :id")
  public List<TvType> listTvType(@Param(value="id") java.lang.String id,  Pageable pageable);
     ...
     */
    @Modifying
    @Query("DELETE FROM Terminal entity WHERE entity.software.id = :instanceId AND entity.tvType.id = :relationId")
