...
/**
 * Controller para expor serviços REST de ForecastingConst
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/ForecastingConst")
public class ForecastingConstREST {
     ...
     */
    @Autowired
    @Qualifier("ForecastingConstBusiness")
    private ForecastingConstBusiness forecastingConstBusiness;
