...
/**
 * Controller para expor serviços REST de ContentTerminal
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/ContentTerminal")
public class ContentTerminalREST {
