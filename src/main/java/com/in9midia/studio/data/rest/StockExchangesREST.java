...
/**
 * Controller para expor serviços REST de StockExchanges
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/StockExchanges")
public class StockExchangesREST {
     ...
     */
    @Autowired
    @Qualifier("StockExchangesBusiness")
    private StockExchangesBusiness stockExchangesBusiness;
