...
/**
 * Controller para expor serviços REST de Themes
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/Themes")
public class ThemesREST {
     ...
     */
    @Autowired
    @Qualifier("ThemesBusiness")
    private ThemesBusiness themesBusiness;
