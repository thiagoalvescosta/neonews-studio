...
/**
 * Controller para expor serviços REST de Route
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/Route")
public class RouteREST {
  ...
  public List<RouteStop> findRouteStop(@PathVariable("instanceId") java.lang.String instanceId, @RequestParam(defaultValue = "100", required = false) Integer limit, @RequestParam(defaultValue = "0", required = false) Integer offset) {
    return routeBusiness.findRouteStop(instanceId,  new PageRequest(offset, limit) );
  }
