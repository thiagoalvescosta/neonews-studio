...
/**
 * Controller para expor serviços REST de Command
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/Command")
public class CommandREST {
   ...
   */
    @Autowired
    @Qualifier("CommandParamBusiness")
    private CommandParamBusiness commandParamBusiness;
   ...
   */
  @RequestMapping(method = RequestMethod.GET
  , value="/{instanceId}/CommandParam")    
  public List<CommandParam> findCommandParam(@PathVariable("instanceId") java.lang.String instanceId, @RequestParam(defaultValue = "100", required = false) Integer limit, @RequestParam(defaultValue = "0", required = false) Integer offset) {
    return commandBusiness.findCommandParam(instanceId,  new PageRequest(offset, limit) );
  }
