...
/**
 * Controller para expor serviços REST de ContentUpdate
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/ContentUpdate")
public class ContentUpdateREST {
