...
/**
 * Controller para expor serviços REST de ExtensionVideo
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/ExtensionVideo")
public class ExtensionVideoREST {
     ...
     */
    @Autowired
    @Qualifier("ExtensionVideoBusiness")
    private ExtensionVideoBusiness extensionVideoBusiness;
