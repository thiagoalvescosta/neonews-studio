...
/**
 * Controller para expor serviços REST de SchedulePredicateTerminal
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/SchedulePredicateTerminal")
public class SchedulePredicateTerminalREST {
