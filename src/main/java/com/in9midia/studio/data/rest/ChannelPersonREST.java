...
/**
 * Controller para expor serviços REST de ChannelPerson
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/ChannelPerson")
public class ChannelPersonREST {
