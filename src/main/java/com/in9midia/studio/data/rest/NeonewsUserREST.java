...
/**
 * Controller para expor serviços REST de NeonewsUser
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/NeonewsUser")
public class NeonewsUserREST {
  ...
  public List<UserCompany> findUserCompany(@PathVariable("instanceId") java.lang.String instanceId, @RequestParam(defaultValue = "100", required = false) Integer limit, @RequestParam(defaultValue = "0", required = false) Integer offset) {
    return neonewsUserBusiness.findUserCompany(instanceId,  new PageRequest(offset, limit) );
  }
  ...
  public List<Company> listCompany(@PathVariable("instanceId") java.lang.String instanceId,  @RequestParam(defaultValue = "100", required = false) Integer limit, @RequestParam(defaultValue = "0", required = false) Integer offset ) {
    return neonewsUserBusiness.listCompany(instanceId,  new PageRequest(offset, limit) );
  }
  ...
  public ResponseEntity<?> deleteCompany(@PathVariable("instanceId") java.lang.String instanceId, @PathVariable("relationId") java.lang.String relationId) {
      this.neonewsUserBusiness.deleteCompany(instanceId, relationId);
      return ResponseEntity.ok().build();
  }  
