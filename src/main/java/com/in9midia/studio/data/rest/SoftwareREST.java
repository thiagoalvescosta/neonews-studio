...
/**
 * Controller para expor serviços REST de Software
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/Software")
public class SoftwareREST {
  ...
  public List<Terminal> findTerminal(@PathVariable("instanceId") java.lang.String instanceId, @RequestParam(defaultValue = "100", required = false) Integer limit, @RequestParam(defaultValue = "0", required = false) Integer offset) {
    return softwareBusiness.findTerminal(instanceId,  new PageRequest(offset, limit) );
  }
