...
/**
 * Controller para expor serviços REST de PatrimonyRemote
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/PatrimonyRemote")
public class PatrimonyRemoteREST {
