...
/**
 * Controller para expor serviços REST de ContentAnswerReport
 * 
 ...
 **/
@RestController
@RequestMapping(value = "/api/rest/com/in9midia/studio/data/ContentAnswerReport")
public class ContentAnswerReportREST {
